...
<head>
  <title>Pricipal - Ostec Corporate Group</title>
  <meta charset="utf-8">
...
<body>
    ...
    <div class="collapse navbar-collapse" id="nav">
       ...
       <ul class="navbar-nav ml-auto bg-light m-0 ml-lg-auto p-3 p-lg-0">
        <li class="d-inline d-lg-none">
            ...
            <li class="nav-item"> <a class="nav-link" href="index.html"><span><i class="fa fa-home"></i></span>Home</a> </li>
          ...
          <div class="dropdown-menu" aria-labelledby="navbarDropdown"> <a href="analytical-products.html" class="dropdown-item">Analytical Products</a> 
        ...
        <li class="nav-item dropdown active"> 
          ...
          <div class="dropdown-menu" aria-labelledby="navbarDropdown"> 
             <a href="neosacn -bave.html" class="dropdown-item">Neosacn Bave</a> 
            ...
            <li class="nav-item"> <a class="btn btn-read" href="#">Login</a> </li>
          </ul>
    </div>
  </div>
</nav>
         ...
         <div class="container-fluid">
             <div class="row">
                 <img src="images/about-banner.jpg" class="img-fluid w-100">
             </div>
            </div>
  ...
  <ol class="breadcrumb">
    ...
    <li class="breadcrumb-item active" aria-current="page">Ostec Corporate Group</li>
  </ol>
</nav>
        </div>
     </div>
    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="heading text-center">
               <h1>Ostec <span>Corporate Group</span></h1>
            </div>
        </div>
    </div>
    <div class="row justify-content-center">      
        <div class="col-md-4 col-sm-6">
            <div class="box-principal">
                <div class="box-img">
                  <img class="pic-1 img-fluid" src="images/RAMOS-S120-kvadratnyy-prozrachnyy.png">
              </div>
              <h4>RAMOS S120</h4>
              <p>RAMOS S120 compact dual-channel confocal Raman microscope</p>
              <a class="btn btn-read" href="http://ostec-instruments.com/products/ramos-120-series/ramos-s120/" target="_blank">View Details</a>
            </div>
        </div>
          <div class="col-md-4 col-sm-6">
            <div class="box-principal">
                <div class="box-img">
                  <img class="pic-1 img-fluid" src="images/mr_page1.tif.png">
              </div>
              <h4>RAMOS E/M series</h4>
              <p>RAMOS E/M Series Raman spectrometers are designed on the basis of research grade optical microscopes </p>
              <a class="btn btn-read" href="http://ostec-instruments.com/products/confocal-raman-solutions/ramos-e-m-series/" target="_blank">View Details</a>
            </div>
        </div>
          <div class="col-md-4 col-sm-6">
            <div class="box-principal">
                <div class="box-img">
                  <img class="pic-1 img-fluid" src="images/NRcommon.tif.png">
              </div>
              <h4>RAMOS N500</h4>
              <p>3D Scanning Laser Raman Microscope</p>
              <a class="btn btn-read" href="http://ostec-instruments.com/products/confocal-raman-solutions/ramos-n500/" target="_blank">View Details</a>
            </div>
        </div>
          <div class="col-md-4 col-sm-6">
            <div class="box-principal">
                <div class="box-img">
                  <img class="pic-1 img-fluid" src="images/IMGP9464_prozrachnyy.png">
              </div>
              <h4>RAMOS U120</h4>
              <p>Neoscan microCT systems are supplied with an in-house developed all-in-one software tool</p>
              <a class="btn btn-read" href="http://ostec-instruments.com/products/ramos-120-series/ramos-u120/" target="_blank">View Details</a>
            </div>
        </div>
        ...
        <div class="col-md-4 col-sm-6">
            <div class="box-principal">
                <div class="box-img">
                  <img class="pic-1 img-fluid" src="images/RS120_transparent.png">
              </div>
              <h4>RAMOS RS120</h4>
              <p>RAMOS RS120. Dual-channel automated Raman spectrometer</p>
              <a class="btn btn-read" href="http://ostec-instruments.com/products/ramos-120-series/ramos-rs120/" target="_blank">View Details</a>
            </div>
        </div>
        <div class="col-md-4 col-sm-6">
            <div class="box-principal">
                <div class="box-img">
                  <img class="pic-1 img-fluid" src="images/SreytBT444A.jpg">
              </div>
              <h4>RAMOS CARS</h4>
              <p>RAMOS CARS 3D scanning laser spectrometer</p>
              <a class="btn btn-read" href="http://ostec-instruments.com/products/confocal-raman-solutions/ramos-cars/" target="_blank">View Details</a>
            </div>
        </div>
    </div>
</div>
