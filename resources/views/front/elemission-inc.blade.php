...
<head>
  <title>Pricipal - Elemission Inc.</title>
  <meta charset="utf-8">
...
<body>
  ...
  <ol class="breadcrumb">
    ...
    <li class="breadcrumb-item active" aria-current="page">Elemission Inc.</li>
  </ol>
</nav>
        </div>
     </div>
    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="heading text-center">
               <h1>Elemission<span> Inc. </span></h1>
            </div>
        </div>
    </div>
    <div class="row justify-content-center">      
        <div class="col-md-4 col-sm-6">
            <div class="box-principal">
                <div class="box-img">
                  <img class="pic-1 img-fluid" src="images/thumb_coriosity_2.webp">
              </div>
              <h4>LIBS ANALYZERS</h4>
              <p>Investigate the exact chemical compounds of your soils, materials and metals</p>
              <a class="btn btn-read" href="https://www.elemission.ca/products" target="_blank">View Details</a>
            </div>
        </div>
          <div class="col-md-4 col-sm-6">
            <div class="box-principal">
                <div class="box-img">
                  <img class="pic-1 img-fluid" src="images/thumb_z118_2.webp">
              </div>
              <h4>ECORE</h4>
              <p>ECORE is the ultimate core scanner: combine the novel geochemical laser ablation sensor to ELEMISSION automation expertise</p>
              <a class="btn btn-read" href="https://www.elemission.ca/ecore" target="_blank">View Details</a>
            </div>
        </div>
          <div class="col-md-4 col-sm-6">
            <div class="box-principal">
                <div class="box-img">
                  <img class="pic-1 img-fluid" src="images/thumb_coriosity.webp">
              </div>
              <h4>CORIOSITY</h4>
              <p>CORIOSITY is the most advanced LIBS hyperspectral imager currently on the market</p>
              <a class="btn btn-read" href="https://www.elemission.ca/coriosity" target="_blank">View Details</a>
            </div>
        </div>
          <div class="col-md-4 col-sm-6">
            <div class="box-principal">
                <div class="box-img">
                  <img class="pic-1 img-fluid" src="images/thumb_slurry.webp">
              </div>
              <h4>Slurry</h4>
              <p>Slurry is ELEMISSION’s all-new fully automated fluid sample analyzer.</p>
              <a class="btn btn-read" href="https://www.elemission.ca/slurry
" target="_blank">View Details</a>
        ...
        <div class="col-md-4 col-sm-6">
            <div class="box-principal">
                <div class="box-img">
                  <img class="pic-1 img-fluid" src="images/thumb_cobra.webp">
              </div>
              <h4>COBRA</h4>
              <p>RAMOS RS120. Dual-channel automated Raman spectrometer</p>
              <a class="btn btn-read" href="https://www.elemission.ca/cobra
" target="_blank">View Details</a>
            </div>
        </div>
        <div class="col-md-4 col-sm-6">
            <div class="box-principal">
                <div class="box-img">
                  <img class="pic-1 img-fluid" src="images/thumb_z118.webp">
              </div>
              <h4>Z118</h4>
              <p>Z118 is the ultimate process analyzer you can find on the market for on-line process analysis</p>
              <a class="btn btn-read" href="https://www.elemission.ca/z118
" target="_blank">View Details</a>
            </div>
        </div>
    </div>
