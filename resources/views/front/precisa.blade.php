...
<body>
  ...
  <ol class="breadcrumb">
    ...
    <li class="breadcrumb-item active" aria-current="page">Precisa</li>
  </ol>
</nav>
        </div>
     </div>
    ...
    <div class="row justify-content-center">      
        <div class="col-md-4 col-sm-6">
            <div class="box-principal">
                <div class="box-img">
                  <img class="pic-1 img-fluid" src="images/Precisa_Balances_390_HF_225SM.jpg">
              </div>
              <h4>H_ 125SM (HF/HA/HE/HM)</h4>
              <p>0.01mg ▪ 125g ▪ Semi-Micro Balancee</p>
              <a class="btn btn-read" href="https://www.precisa.com/products?f=Semi-Micro" target="_blank">View Details</a>
            </div>
        </div>
          <div class="col-md-4 col-sm-6">
            <div class="box-principal">
                <div class="box-img">
                  <img class="pic-1 img-fluid" src="images/Precisa_Balances_360_EP_120A.jpg">
              </div>
              <h4>EP 120A</h4>
              <p>0.1mg ▪ 120g ▪ Analytical Balances </p>
              <a class="btn btn-read" href="https://www.precisa.com/products?f=Analytical" target="_blank">View Details</a>
            </div>
        </div>
          <div class="col-md-4 col-sm-6">
            <div class="box-principal">
                <div class="box-img">
                  <img class="pic-1 img-fluid" src="images/Precisa_Balances_321_LT_620M.jpg">
              </div>
              <h4>LT 160M</h4>
              <p>1mg ▪ 160g ▪ Precision Balance</p>
              <a class="btn btn-read" href="https://www.precisa.com/products?f=Precision" target="_blank">View Details</a>
            </div>
        </div>
          <div class="col-md-4 col-sm-6">
            <div class="box-principal">
                <div class="box-img">
                  <img class="pic-1 img-fluid" src="images/Precisa_Moisture_Analyzers_365-EM_120.jpg">
              </div>
              <h4>EM 120-HR</h4>
              <p>0.1mg / 0.001% ▪ 124g ▪ Moisture Analyzer</p>
              <a class="btn btn-read" href="https://www.precisa.com/products?f=Moisture%20Analyzers" target="_blank">View Details</a>
            </div>
        </div>
        ...
        <div class="col-md-4 col-sm-6">
            <div class="box-principal">
                <div class="box-img">
                  <img class="pic-1 img-fluid" src="images/Prepash_open.jpg">
              </div>
              <h4>prepASH 229</h4>
              <p>0.1mg ▪ 29 Samples ▪ Ash Analyzer (Macro-TGA)</p>
              <a class="btn btn-read" href="https://www.precisa.com/products?f=Ash%20Analyzers" target="_blank">View Details</a>
            </div>
        </div>
    </div>
</div>
