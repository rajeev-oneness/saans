        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="nav">
                ...
                <ul class="navbar-nav ml-auto bg-light m-0 ml-lg-auto p-3 p-lg-0">
                    ...
                    <li class="nav-item active"> <a class="nav-link" href="{{ url('/') }}"><span><i
                                    class="fa fa-home"></i></span>Home</a> </li>
                    <li class="nav-item"> <a class="nav-link" href="{{ url('/about-us') }}">About Us</a>
                    </li>
                    ...
                    <li class="nav-item dropdown">
                        <a class="nav-link dropdown-toggle" href="#" id="navbarDropdownMenuLink" role="button"
                            data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Principals</a>
                                        ...
                                        <ul class="dropdown-menu">
                                            @foreach ($principal->subPrinciple as $subPrincipal)
                                                <li><a class="dropdown-item"
                                                        href="{{ url('/principal', $subPrincipal->id) }}">{{ $subPrincipal->sub_principal }}</a>
                                                </li>
                                            @endforeach
                    ...
                    <li class="nav-item dropdown">
                        <a class="nav-link" href="{{ route('front.category') }}" role="button"
