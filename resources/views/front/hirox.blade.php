...
<body>
  ...
  <ol class="breadcrumb">
    ...
    <li class="breadcrumb-item active" aria-current="page">Hirox</li>
  </ol>
</nav>
        </div>
     </div>
    ...
    <div class="row justify-content-center">      
        <div class="col-sm-6">
            <div class="box-principal">
                <div class="box-img">
                  <img class="pic-1 img-fluid" src="images/HRX-01-FULLSYSTEM-3D-3.png">
              </div>
              <h4>HRX-01-FULLSYSTEM-3D</h4>
              <p>The HRX-01 is the result of over 40 years of optical manufacturing from Hirox</p>
              <a class="btn btn-read" href="https://hirox-europe.com/products/3d-digital-microscope/hrx-01-new-3d-digital-microscope/" target="_blank">View Details</a>
            </div>
        </div>
          <div class="col-sm-6">
            <div class="box-principal">
                <div class="box-img">
                  <img class="pic-1 img-fluid" src="images/RH-2000_full_system_500-1-e1577955546711.png">
              </div>
              <h4>RH-2000 System</h4>
              <p>New Revolutionary Hardware</p>
              <a class="btn btn-read" href="https://hirox-europe.com/products/3d-digital-microscope/rh-2000/" target="_blank">View Details</a>
            </div>
        </div>
    </div>
</div>
