        ...
        <div class="left">
          <div class="order-div2">
            <div class="px-15">
              ...
              <p class="sub-head">{{$banar->sub_title}}</p> <a href="{{ url('/contact') }}" class="btn btn-read mt-2">Contact Us<i class="fa fa-arrow-circle-right"></i></a> <a href="#" class="btn btn-read mt-2">Learn more</a>
            </div>
          </div>
        </div>
        <div class="right">
      ...
      <div class="d-sm-flex flex-sm-wrap flex-lg-nowrap align-items-center justify-content-between">
        <div class="left">
          <div class="order-div2">
            <div class="px-15">
              <p class="head">We supply all kind of commonly use<span> biological systems Collection</span> <span class="animate-border border-black"></span></p>
              <p class="sub-head">Also we are into marketing of all kind of Optical Microscope including Metallurgical, Polarizing, Stereo Zoom, and Spectrophotometer for pharmaceutical industry.</p> <a href="#" class="btn btn-read mt-2">Contact Us<i class="fa fa-arrow-circle-right"></i></a> <a href="#" class="btn btn-read mt-2">Learn more</a>
            </div>
          </div>
        </div>
        <div class="right">
  ...
  <div class="container">
    <div class="row">
      <div class="col-lg-6 wow fadeInLeft" data-wow-duration="2s">
        <div class="about-box">
          <p><span>06+</span>
            <br />YEARS OF WORKING EXPERIENCE IN THIS FIELD
          </p>
    ...
    <div class="row align-items-center">
      <div class="col-sm-8">
        <div class="sub-heading wow fadeInDown" data-wow-duration="2s">
          <h4>Our Products</h4>
          <h2><span>Innovation and Implementing Advanced Technology</span></h2>
        </div>
      </div>
  ...
  <div class="container">
    <div class="row">
      ...
      <div class="col-lg-4 wow fadeInDown" data-wow-duration="2s">
        <div class="pro-box">
          <div class="pro-icon">
            <!-- <i class="fa fa-cog"></i> --><img src="{{ asset('front/images/icon2.png') }}" alt="" class="img-fluid mx-auto d-block w-50">
          </div>
          ...
          <div class="owl-item">
            <div class="d-sm-flex justify-content-between align-items-center bg-feature">
              ...
              <div class="feature-text">
                ...
                <a href="{{ url('product-details',$product->id)}}">View Details</a>
              </div>
            </div>
          </div>
          @endforeach
