...
<head>
  <title>Pricipal - ORS (Object Research Systems) for Dragonfly Software</title>
  <meta charset="utf-8">
...
<body>
  ...
  <ol class="breadcrumb">
    ...
    <li class="breadcrumb-item active" aria-current="page">ORS (Object Research Systems) for Dragonfly Software</li>
  </ol>
</nav>
        </div>
     </div>
    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="heading text-center">
               <h1>ORS (Object Research Systems) <span> for Dragonfly Software </span></h1>
            </div>
        </div>
    </div>
    <div class="row justify-content-center">      
        <div class="col-md-12">
            <div class="box-principal">
                <div class="box-img">
                  <img class="pic-1 img-fluid" src="images/banner-archived-lessons.png">
              </div>
              <h4>Recorded Webinars</h4>
              <p>Learn more about all the features of Dragonfly…</p>
              <a class="btn btn-read" href="https://www.theobjects.com/dragonfly/index.html" target="_blank">View Details</a>
            </div>
        </div>
    </div>
</div>
