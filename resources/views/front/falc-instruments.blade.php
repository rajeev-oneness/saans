...
<head>
  <title>Pricipal - FALC Instruments</title>
  <meta charset="utf-8">
...
<body>
  ...
  <ol class="breadcrumb">
    ...
    <li class="breadcrumb-item active" aria-current="page">FALC Instruments</li>
  </ol>
</nav>
        </div>
     </div>
    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="heading text-center">
               <h1>FALC <span>Instruments</span></h1>
            </div>
        </div>
    </div>
    <div class="row justify-content-center">      
        <div class="col-md-4 col-sm-6">
            <div class="box-principal">
                <div class="box-img">
                  <img class="pic-1 img-fluid" src="images/singoli.jpg">
              </div>
              <h4>F91T</h4>
              <p>Stainless steel structure painted with anti-acid epoxy powder coating
</p>
              <a class="btn btn-read" href="https://www.falcinstruments.it/en/3-stirrers" target="_blank">View Details</a>
            </div>
        </div>
          <div class="col-md-4 col-sm-6">
            <div class="box-principal">
                <div class="box-img">
                  <img class="pic-1 img-fluid" src="images/atv20-hydra-evo.jpg">
              </div>
              <h4>AUTOCLAVES CLASS N ATV20 - 16 LT</h4>
              <p>Class N medical devices. Front-loading sterilizer ATV 20, for steam sterilisation of wrapped or unwrapped instruments.

 </p>
              <a class="btn btn-read" href="https://www.falcinstruments.it/en/90146-autoclaves
" target="_blank">View Details</a>
          ...
          <div class="col-md-4 col-sm-6">
            <div class="box-principal">
                <div class="box-img">
                  <img class="pic-1 img-fluid" src="images/water-baths.jpg">
              </div>
              <h4>WB-M15</h4>
              <p>*CAPACITY 5 - 15 - 24 lt * External case in ABS CAPACITY 50 lt * External case in steel painted with epoxy paint ALL CAPACITY

</p>
              <a class="btn btn-read" href="https://www.falcinstruments.it/en/5-thermostatic-baths
" target="_blank">View Details</a>
            </div>
        </div>
          <div class="col-md-4 col-sm-6">
            <div class="box-principal">
                <div class="box-img">
                  <img class="pic-1 img-fluid" src="images/labsonic-lbs1-06.jpg">
              </div>
              <h4>LABSONIC LBS1 -0,6</h4>
              ...
              <a class="btn btn-read" href="https://www.falcinstruments.it/en/6-ultrasonic-baths
...
" target="_blank">View Details</a>
        ...
        <div class="col-md-4 col-sm-6">
            <div class="box-principal">
                <div class="box-img">
                  <img class="pic-1 img-fluid" src="images/thermocycler-mixer.jpg">
              </div>
              <h4>THERMOCYCLER MIXER</h4>
              <p>Rotating mixer thermal cycler, combines mixing and temperature functions, thermal ABS external structure.</p>
              <a class="btn btn-read" href="https://www.falcinstruments.it/en/14-thermocyclers" target="_blank">View Details</a>
            </div>
        </div>
    </div>
</div>
