                            ...
                            <form method="POST" action="{{ route('update.product', ['id' => $product->id]) }}"
                                ...
                                <div class="form-group required">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="file" class="form-control-file" name="image1"
                                            value="{{ $product->image1 }}" id="image1">
                                    </div>
                                    <img src="{{ asset($product->image2) }}" height="200px" width="300px">
                                    <div class="form-group">
                                        <label for="image2" class="control-label">Image Two</label>
                                        <input type="file" class="form-control-file" name="image2"
                                            value="{{ $product->image2 }}" id="image2">
                                    </div>
                                    <img src="{{ asset($product->image3) }}" height="200px" width="300px">
                                    <div class="form-group required">
                                        <label for="image3" class="control-label">Image Three</label>
                                        <input type="file" class="form-control-file" name="image3"
                                            value="{{ $product->image3 }}" id="image3">
                                    </div>
                                    <img src="{{ asset($product->image4) }}" height="200px" width="300px">
                                    <div class="form-group required">
                                        <label for="image4" class="control-label">Image Four</label>
                                        <input type="file" class="form-control-file" name="image4"
                                            value="{{ $product->image4 }}" id="image4">
                                    </div>
                                    <img src="{{ asset($product->image5) }}" height="200px" width="300px">
                                    <div class="form-group required">
                                        <label for="image5" class="control-label">Image Five</label>
                                        <input type="file" class="form-control-file" name="image5"
                                            value="{{ $product->image5 }}" id="image5image">
                                    </div>
                                ...
                                <div class="form-group required">
                                    ...
                                    <input type="text" name="name" id="name" value="{{ $product->name }}"
                                        placeholder="Course name" class="form-control @error('name') is-invalid @enderror">
                                    @error('name')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                                ...
                                <div class="form-group required">
                                    ...
                                    <select id="categoryId" name="categoryId"
                                        ...
                                        @foreach ($categories as $category)
                                            <option value="{{ $category->id }}" @if ($product->categoryId == $category->id){{ 'selected' }}@endif>
                                ...
                                <div class="form-group required">
                                    ...
                                    <select id="subCategory" name="subCategoryId"
                                        ...
                                        @foreach ($subCategories as $subCategory)
                                            <option value="{{ $subCategory->id }}" @if ($product->subCategoryId == $subCategory->id){{ 'selected' }}@endif>
                                ...
                                <div class="form-group required">
                                    ...
                                    <select id="principalId" name="principalId"
                                        class="form-control @error('principalId') is-invalid @enderror">
                                        <option selected disabled>Select one</option>
                                        @foreach ($principals as $principal)
                                            <option value="{{ $principal->id }}" @if ($product->principalId == $principal->id){{ 'selected' }}@endif>
                                ...
                                <div class="form-group required">
                                    ...
                                    <select id="subPrincipalId" name="subPrincipalId"
                                        class="form-control @error('subPrincipalId') is-invalid @enderror">
                                        <option selected disabled>Select one</option>
                                        @foreach ($subPrincipals as $subPrincipal)
                                            <option value="{{ $subPrincipal->id }}" @if ($product->subPrincipalId == $subPrincipal->id){{ 'selected' }}@endif>
                                                {{ $subPrincipal->sub_principal }}</option>
                                        @endforeach
                                    </select>
                                ...
                                <div class="form-group required">
                                    ...
                                    <input type="text" name="feature" value="{{ $product->feature }}" id="duration"
                                        placeholder="Feature" class="form-control @error('feature') is-invalid @enderror">
                                    @error('feature')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                                ...
                                <div class="form-group required">
                                    ...
                                    <input type="text" name="larger_specification"
                                        value="{{ $product->larger_specification }}" id="duration"
                                        placeholder="Larger Specification"
                                        class="form-control @error('larger_specification') is-invalid @enderror">
                                ...
                                <div class="form-group required">
                                    ...
                                    <input type="text" name="redirect_link" value="{{ $product->redirect_link }}"
                                        id="duration" placeholder="Link"
                ...
                $.ajax({
                    ...
                    success: function(result) {
                        ...
                        $.each(result.sub, function(key, val) {
                            options += '<option value="' + val.id + '">' + val
        ...
        $(document).ready(function() {
            ...
            $('#principalId').on('change', function() {
                ...
                $.ajax({
                    ...
                    success: function(result) {
                        var options =
                            '<option value="" selected="" hidden="">Select Sub-Principal</option>';
                        $.each(result.sub, function(key, val) {
                            options += '<option value="' + val.id + '">' + val
                                .sub_principal + '</option>';
                        });
