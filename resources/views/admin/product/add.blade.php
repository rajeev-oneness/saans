                                ...
                                <div class="card-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="form-control @error('categoryId') is-invalid @enderror"
                                            name="categoryId" id="categoryId" value="{{ old('categoryId') }}">
                                    ...
                                    <div class="form-group required">
                                        ...
                                        <select class="form-control @error('principalId') is-invalid @enderror"
                                            name="principalId" id="principalId" value="{{ old('principalId') }}">
                                            <option selected disabled>Select one</option>
                                    ...
                                    <div class="form-group required">
                                        ...
                                        <select class="form-control @error('subPrincipalId') is-invalid @enderror"
                                            name="subPrincipalId" id="subPrincipalId"
                                            value="{{ old('subPrincipalId') }}">
                                            <option selected disabled>Select one</option>
                                        </select>
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="larger_specification" name="larger_specification"
                                            class="form-control @error('larger_specification') is-invalid @enderror"
                                            value="{{ old('larger_specification') }}">
