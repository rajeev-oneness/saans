...
<div class="content-wrapper">
    ...
    <section class="content">
        ...
        @endif
        <form action="{{ route('store.about.company') }}" method="POST" enctype="multipart/form-data">
            @csrf
            <div>
            <div class="row">
                <div class="col-md-12">
                <div class="card card-primary">
                   ...
                   <!--  <div class="card-tools">
                    ...
                    <div class="form-group">
                            ...
                            <textarea name="content" id="content" class="ckeditor form-control @error('content') is-invalid @enderror" value="{{ old('content') }}" style="min-height: 100px;max-height: 300px" placeholder="Content"></textarea>
                            @error('content')
